...
Progression.tiers = {
    ...
    [8] = { name = "TBC Tier 1", objective = "Clear T4 raids" },
    [9] = { name = "TBC Tier 2", objective = "Clear SSC/TK" },
    [10] = { name = "TBC Tier 3", objective = "Clear Hyjal/BT" },
    [11] = { name = "TBC Tier 4", objective = "Clear Zul'Aman" },
    [12] = { name = "TBC Tier 5", objective = "Clear Sunwell" },
    [13] = { name = "WotLK Tier 1", objective = "Clear Naxx/EoE/OS" },
    [14] = { name = "WotLK Tier 2", objective = "Clear Ulduar" },
    [15] = { name = "WotLK Tier 3", objective = "Clear TotC" },
    [16] = { name = "WotLK Tier 4", objective = "Clear ICC" },
    [17] = { name = "WotLK Tier 5", objective = "Clear Ruby Sanctum" },
    [18] = { name = "WotLK Complete", objective = "Complete" },
}
